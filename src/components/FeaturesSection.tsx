      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center mb-16 lg:mb-20">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 lg:gap-8 w-full max-w-6xl">
            ...
            {/* Title */}
            <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-[#101828] tracking-wide whitespace-nowrap">
          ...
          {/* Subtitle */}
          <p className="mt-6 text-[#4a5565] text-lg lg:text-xl max-w-3xl text-center leading-relaxed font-light">
            {t.features.subtitle}
          </p>
        </div>

        {/* Features Grid - No Card Style */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12 max-w-7xl mx-auto">{/* Changed from gap-12 lg:gap-14 to gap-10 lg:gap-12 */}
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative mb-6 w-24 h-24 flex items-center justify-center">{/* Changed from w-28 h-28 to w-24 h-24 */}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    {index === 0 && (
                      <>
                        ...
                        <div className="absolute top-3 left-2 w-16 h-16 rounded-full bg-gray-100/60 border-2 border-gray-200/30">
                          {/* Continents as irregular blobs */}
                          <div className="absolute top-2 left-3 w-6 h-5 bg-gray-200/50 rounded-full transform -rotate-12" />
                          <div className="absolute bottom-4 right-2 w-5 h-4 bg-gray-200/50" style={{borderRadius: '40% 60% 60% 40%'}} />
                        </div>
                        ...
                        <div className="absolute bottom-10 left-10 w-2 h-2 rounded-full bg-gray-200/60" />
                      </>
                    )}
                    ...
                    {index === 1 && (
                      <>
                        ...
                        <div className="absolute top-2 left-3 w-16 h-12 rounded-2xl bg-gray-50/70 border-2 border-gray-200/30 transform rotate-6">
                          {/* Text lines */}
                          <div className="absolute top-2.5 left-2 w-9 h-0.5 bg-gray-200/50 rounded-full" />
                          <div className="absolute top-5 left-2 w-7 h-0.5 bg-gray-200/40 rounded-full" />
                          {/* AI indicator dot */}
                          <div className="absolute bottom-2 right-2 w-1.5 h-1.5 rounded-full bg-[#FF6900]/30" />
                        </div>
                        {/* Small response bubble - square with tail */}
                        <div className="absolute bottom-5 right-3 w-10 h-8 bg-gray-100/60 border-2 border-gray-200/25 rounded-xl transform -rotate-6">
                          <div className="absolute top-2 left-2 flex gap-0.5">
                            <div className="w-1 h-1 rounded-full bg-gray-300/50" />
                            <div className="w-1 h-1 rounded-full bg-gray-300/50" />
                            <div className="w-1 h-1 rounded-full bg-gray-300/50" />
                          </div>
                        </div>
                    ...
                    {index === 2 && (
                      <>
                        ...
                        <div className="absolute top-3 right-3 w-14 h-14 bg-gray-100/60 border-2 border-gray-200/30 rounded-full">
                          <div className="absolute top-2.5 left-2.5 w-4 h-4 rounded-full bg-gray-200/40" />
                          <div className="absolute bottom-3 right-3 w-2.5 h-2.5 rounded-full bg-gray-150/30" />
                        </div>
                        {/* Star shapes - 5-point stars */}
                        <div className="absolute bottom-6 left-4 w-6 h-6 bg-gray-50/70" 
                             style={{clipPath: 'polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)'}} />
                        <div className="absolute top-6 left-3 w-3.5 h-3.5 bg-[#FF6900]/20" 
                             style={{clipPath: 'polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)'}} />
                        {/* Trajectory curve - arc line */}
                        <div className="absolute bottom-3 right-6 w-12 h-12 border-2 border-dashed border-gray-200/30 rounded-full" style={{clipPath: 'polygon(0 100%, 0 0, 100% 100%)'}} />
                      </>
                    )}
                    ...
                    {index === 3 && (
                      <>
                        ...
                        <div className="absolute top-2 right-2 w-16 h-18 bg-gray-50/70 border-2 border-gray-200/30 transform -rotate-6 rounded-lg">
                          {/* Text lines */}
                          <div className="absolute top-3 left-2 w-10 h-0.5 bg-gray-200/50 rounded" />
                          <div className="absolute top-6 left-2 w-8 h-0.5 bg-gray-200/40 rounded" />
                          <div className="absolute top-9 left-2 w-9 h-0.5 bg-gray-200/45 rounded" />
                          <div className="absolute top-12 left-2 w-7 h-0.5 bg-gray-200/40 rounded" />
                        </div>
                        {/* Second paper - organic wavy edge */}
                        <div className="absolute bottom-5 left-3 w-12 h-14 bg-gray-100/50 border border-gray-200/25 rounded-md transform rotate-3" 
                        ...
                        <div className="absolute top-2 right-2 w-5 h-5 bg-gray-200/40" style={{clipPath: 'polygon(100% 0, 100% 100%, 0 0)'}} />
                      </>
                    )}
                    ...
                    {index === 4 && (
                      <>
                        ...
                        <div className="absolute top-5 left-3 w-14 h-14 bg-gray-100/60 border-2 border-gray-200/30 transform rotate-12" 
                             style={{clipPath: 'polygon(30% 0%, 70% 0%, 100% 50%, 70% 100%, 30% 100%, 0% 50%)'}}>
                          {/* Inner star */}
                          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-5 h-5 bg-gray-200/50" 
                               style={{clipPath: 'polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)'}} />
                        </div>
                        {/* Seal stamp - circle */}
                        <div className="absolute bottom-3 right-5 w-9 h-9 rounded-full bg-gray-50/70 border-2 border-gray-200/25 flex items-center justify-center">
                          <div className="w-5 h-5 rounded-full border-2 border-dashed border-gray-300/40" />
                        </div>
                        {/* Ribbon - rectangles */}
                    ...
                    {index === 5 && (
                      <>
                        ...
                        <Users className="absolute top-2 left-2 w-20 h-20 text-gray-200/40 z-10" />
                      </>
                    )}
                  </div>
                  
                  {/* Main orange icon - pure icon without background */}
                  <Icon className={`relative z-10 w-14 h-14 text-[#FF6900] ${index === 5 ? 'translate-x-5' : ''}`} />
                </div>
                
                {/* Title */}
                <h3 className="text-[#FF6900] mb-4">{feature.title}</h3>
                
                {/* Description */}
                <p className="text-[#999999] leading-relaxed max-w-xs">
                  {feature.description}
                </p>
              </div>
            );

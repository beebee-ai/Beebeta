...
function DialogContent(
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-[#ffc75a] focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none bg-zinc-900 hover:bg-zinc-800 p-2 border border-[#ffc75a]/20 hover:border-[#ffc75a]/50">
          <XIcon className="h-5 w-5 text-[#ffc75a]" />
